...
function renderSettings() {
  ...
  return `
    <div class="page-header">
      <div>
        <div class="h-eyebrow">고정비 · 직원 · 데이터</div>
        ...
        ${PMS.staff.map(s => `
          <button class="settings-row" style="width: 100%; text-align: left;" data-modal="staff">
            <div style="display: flex; gap: 12px; align-items: center;">
              <div class="avatar" style="width: 36px; height: 36px; font-size: 13px;">${s.name[0]}</div>
              <div>
...
// Expose
window.PAGES_EXTRA = { renderCalendar, renderSettings, renderTax, renderSiteDetail };
