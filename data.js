...
window.MOCK = {
  ...
  phases: ['공사준비', '철거', '창호', '전기', '욕실방수', '목공', '타일', '필름', '욕실설비', '바닥', '도배', '가구', '조명마감', '중문', '실리콘', '잔마감'],
  defaultSitePhases: ['한샘철거','아트철거','마루철거','전기배선','욕실 도막방수','목공','가스관철거','타일','타일메지','필름','탄성코트','가구실측','욕실도기설비','천정돔','폐기물 반출','바닥','도배','가구','상판','전기조명 마감','입주청소','실리콘 마감','사진촬영'],
